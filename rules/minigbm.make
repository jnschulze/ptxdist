...
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_EXYNOS)	+= -DGBM_EXYNOS
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_GMA500)	+= -DGBM_GBA500
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_I915)		+= -DGBM_I915
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_MARVELL)	+= -DGBM_MARVELL
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_MEDIATEK)	+= -DGBM_MEDIATEK
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_ROCKCHIP)	+= -DGBM_ROCKCHIP
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_TEGRA)	+= -DGBM_TEGRA
MINIGBM_DRIVERS-$(PTXCONF_MINIGBM_VC4)		+= -DGBM_VC4
